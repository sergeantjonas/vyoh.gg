...
describe("section-variants", () => {
  ...
  it("exposes the four editorial child roles, each with hidden + visible", () => {
    const roles = ["eyebrow", "headline", "meta", "body"] as const;
  ...
  it("gives the headline the most pronounced Y offset of the four roles", () => {
