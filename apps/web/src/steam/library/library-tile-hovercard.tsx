...
// `z-30` sits below the top nav (z-50) and the section header band (z-40)
// so a card opened on a trigger that's partially behind those sticky bands
// is clipped by them instead of floating over them.
    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col gap-2 p-3">
        ...
        {game.shortDescription !== null && (
          <p className="text-xs text-muted-foreground italic">{game.shortDescription}</p>
        )}
