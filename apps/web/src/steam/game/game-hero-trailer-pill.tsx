...
//
// Why a quick microtrailer crossfade rather than opening the full-trailer
// modal: the pill is the *quick peek* affordance. The full-trailer modal
// (with audio, adaptive streaming, native controls) is reached by clicking
// a trailer thumbnail in the GameScreenshotStrip carousel below the hero —
// that's where the multi-trailer browse experience lives.
