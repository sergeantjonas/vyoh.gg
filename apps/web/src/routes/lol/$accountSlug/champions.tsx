...
// Parent layout for /lol/$accountSlug/champions/*. Owns the champion list +
// filters so opening a $championKey panel does NOT unmount the list — sort
// state, role filter, and aggregated stats persist while the panel overlays
// it. Child routes (`/`, `/$championKey`) render into the Outlet at the
// bottom; the $championKey child wraps its content in <SlidePanel>.
