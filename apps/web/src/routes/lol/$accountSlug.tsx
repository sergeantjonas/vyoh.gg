...
import {
  AccountControlsSlotProvider,
  useAccountControlsSlotState,
} from "@/lol/_shared/account-controls-slot";
...
function AccountLayout() {
  ...
  const [controlsSlotEl, setControlsSlotEl] = useAccountControlsSlotState();
