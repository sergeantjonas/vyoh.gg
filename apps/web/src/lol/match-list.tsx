        ...
        <m.li key={match.matchId} variants={item}>
          ...
          >
            <img
              ...
              aria-hidden="true"
              loading="lazy"
              className="pointer-events-none absolute inset-0 size-full object-cover object-[center_35%] opacity-80 transition-opacity duration-300 group-hover:opacity-100"
            />
