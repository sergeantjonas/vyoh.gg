...
export function ProfileOnThisDay({ accountSlug }: { accountSlug: string }) {
  ...
  // Gated here rather than at the call site: on an empty day there is nothing
  // to reserve height for, and gating after the guard keeps the frosted rows
  // from promoting layers on a cold load of a page they sit far below.
  return (
    <CvSection minHeight={180}>
