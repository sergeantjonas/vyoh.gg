...
1. ⚠️ **Duo / squad detection** — v1 shipped 2026-05-10 (Profile section showing top recurring teammates with W-L + most-played champion). Squad detection (3+ groupings), LP-overlay graphs, shared champion-pair stats, and match-list highlighting deferred to follow-up sessions.
