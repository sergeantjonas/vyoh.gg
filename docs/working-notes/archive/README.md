...
|---|---|---|
| [home-deck.md](home-deck.md) | 2026-05-14 | Chunks 1 + 2 both shipped; the home page has since grown additional tiles directly in `apps/web/src/home/` and future tile candidates live in [self-portrait-surfaces.md](../self-portrait-surfaces.md), not here. |
