...
- **2026-06-12 visual-excellence audit** — in progress (session plan: V1+V2, V5, V8). V1.1 remake filters (5 sites) + V1.2 `ChapterLabel` header recipe (17 sites) + V1.3 `ChapterShell` recap wrappers (13 sites) shipped; remaining V1 sweep item (retired opacity rungs ×15 + canonical empty-state recipe) + V2 enforcement test next; V3–V7 surface passes (patches identity, subtab transitions, head/meta, focus ring, status); V8 chart theming (sequence with KB file 20's Recharts audit); V9–V12 design decisions. → [visual-excellence-audit-2026-06-12.md](cross-cutting/visual-excellence-audit-2026-06-12.md)
