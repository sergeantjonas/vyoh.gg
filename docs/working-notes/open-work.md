...
- **Match-depth Phase D remainders** — squad detection **API shipped 2026-06-16** (`getSquads`/`GET …/squads`); `ProfileSquads` web surface next. LP-overlay graphs per duo (blocked on owner-auth), per-duo champion pairs (needs stable squad detection), D.2–D.7. (Match-list duo highlight shipped 2026-06-15.) → [match-depth-roadmap.md](lol/match-depth-roadmap.md)
