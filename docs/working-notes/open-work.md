...
- **Personal-baselines PB1** — doc-pass tagging each tile's baseline kind (personal / role-population / fixed-reference). (PB2 weakest-matchup + PB3 patch-drift verdicts both shipped 2026-05-14; PB4 cross-tile anomalies still deferred.) → [personal-baselines.md](personal-baselines.md)
