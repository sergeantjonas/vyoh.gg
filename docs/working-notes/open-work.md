...
- **Match-depth Phase D remainders** — squad detection (3+ groupings), LP-overlay graphs per duo, per-duo champion pairs, D.2–D.7. (Match-list duo highlight shipped 2026-06-15.) → [match-depth-roadmap.md](lol/match-depth-roadmap.md)
