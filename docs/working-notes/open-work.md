...
- **Match-depth Phase D remainders** — squad detection **shipped end-to-end 2026-06-16** (`getSquads`/`GET …/squads` + `ProfileSquads` web section); per-duo champion pairs **shipped 2026-06-16** (`Duo.championPairs` + expandable `ProfileDuos` rows). **D.9 rune-page diversity shipped 2026-06-17** (`GET …/champions/:championKey/rune-diversity` + `ChampionRuneDiversity` tile on Champion detail). Remaining: LP-overlay graphs per duo (blocked on owner-auth), D.2–D.7. (Match-list duo highlight shipped 2026-06-15.) → [match-depth-roadmap.md](lol/match-depth-roadmap.md)
