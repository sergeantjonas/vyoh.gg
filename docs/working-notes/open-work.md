...
- **Editorial typography (Tier 2)** — Chunk 1 (Geist axis verification) shipped 2026-05-27: `wght` 100–900 continuous confirmed, `opsz`/italic not exposed; design holds for 720/380 weight pairing. Remaining: Chunk 2 (`HeroNumber`/`HeroLabel` primitives + test), Chunks 3–6 (Profile → match → champion → trends + bento → section-title sweep), Chunk 7 (number-formatter consolidation in `@vyoh/shared`). → [editorial-typography.md](cross-cutting/editorial-typography.md)
