...
- **2026-06-12 visual-excellence audit** — fan-out index: V1 consistency sweep (3 inline remake filters, ~15 recap ad-hoc headers, hand-rolled frosted recipe ×7, retired opacity rungs ×15) + V2 enforcement test ready now as one session; V3–V7 surface passes (patches identity, subtab transitions, head/meta, focus ring, status); V8 chart theming (sequence with KB file 20's Recharts audit); V9–V12 design decisions. → [visual-excellence-audit-2026-06-12.md](cross-cutting/visual-excellence-audit-2026-06-12.md)
