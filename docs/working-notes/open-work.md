...
- **2026-06-12 visual-excellence audit** — in progress (session plan: V1+V2, V5, V8). V1 sweep + V2 enforcement test + V5 head/meta shipped (remake filters, `ChapterLabel`, `ChapterShell`, `EMPTY_FRAME_CLASS`, conventions.spec header/rung assertions, subtab + Steam-index `routeMeta`); V3/V4/V6/V7 surface passes (patches identity, subtab transitions, focus ring, status); V8 chart theming (sequence with KB file 20's Recharts audit); V9–V12 design decisions. → [visual-excellence-audit-2026-06-12.md](cross-cutting/visual-excellence-audit-2026-06-12.md)
