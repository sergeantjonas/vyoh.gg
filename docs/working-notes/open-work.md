...
- **Match-detail section nav MDN5** — soft re-evaluation of the Recap / Your game / Timeline grouping after the queued owner-data additions land. Data path (1.A) + spell-cast strip (1.B) shipped 2026-05-21; damage profile (1.C) and owner stats/multikills (1.D) in progress. MDN5 re-eval unblocks once 1.C+1.D land. → [match-detail-section-nav.md](lol/match-detail-section-nav.md) + [lol-owner-data-features.md](lol/lol-owner-data-features.md)
