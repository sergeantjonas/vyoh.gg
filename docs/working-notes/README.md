...
- `lol/match-depth-roadmap.md` — match-detail expansion arc. Phases A/B/C fully shipped (2026-05-16); **Phase D complete 2026-09-01** (LP-overlay per duo last, owner-only); Phase E: full rune page panel shipped 2026-09-08 (owner-only, Your Game tab); the composite "Score-of-game" S grade stays gated in [open-work.md](open-work.md); parked sub-items in [parked.md](parked.md). Read this for context before scoping any remaining D/E item.
