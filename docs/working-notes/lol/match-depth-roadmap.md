...
**Status:** Active — Phases A + B + C fully shipped (2026-05-16). Phase D and Phase E partial: outstanding D items (LP-overlay per duo — owner-only `GET …/duos/lp` + the per-duo LP split on the Profile duo rows shipped 2026-09-01, the LP-history chart marks are the remaining half; squad detection + per-duo champion pairs shipped 2026-06-16, D.9/D.2/D.4/D.5/D.3 shipped 2026-06-17→18, D.6 shipped 2026-06-21, D.7 shipped 2026-06-22 — Phase D now complete except LP-overlay) and E remainders (full rune page, composite S grade) tracked in [open-work.md](../open-work.md); parked sub-items (build-order component-collapse, hover-highlight, boot collapse, soul drake type) in [parked.md](../parked.md). Full Status section with commit refs is [further down](#status).
