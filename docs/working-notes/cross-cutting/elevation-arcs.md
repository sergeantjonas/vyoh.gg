...
| [microtrailer-hover-preview](microtrailer-hover-preview.md) | Steam library hovercard's media slot plays the game's 6-second silent microtrailer in place of the screenshot rotation (Radix-singleton, reduced-motion poster fallback); from the 2026-05-24 GetItems harvest. Redesigned 2026-05-28 from tile-level reveal → hovercard slot. | Chunk 1 shipped 2026-05-28 (b242811); Chunks 2-3 next, optional Chunk 4 game-detail pill. |
