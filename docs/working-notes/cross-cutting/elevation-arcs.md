...
| [scroll-driven-shell](../archive/scroll-driven-shell.md) | Native CSS `animation-timeline: scroll()/view()` on nav, splash backdrop opacity, section progress bar — zero JS | ✅ Shipped 2026-05-26 |
