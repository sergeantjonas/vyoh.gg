...
| [anchor-positioned-overlays](anchor-positioned-overlays.md) | CSS Anchor Positioning for command-palette result peek + hover-card follow-on-scroll; feature-detect + Oddbird polyfill fallback | 🟡 In flight — Chunks 1, 2, 3a, 3b landed 2026-05-27 → 2026-05-28 (feature-detect, anchor-wired preview shell, sentinel-prefix dispatch parser, champion preview content). Chunks 3c/3d (match + Steam game), 4–7 pending. |
