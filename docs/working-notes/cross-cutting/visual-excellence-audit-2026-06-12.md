...
**Status:** Active — audit complete (4-scout fan-out + targeted verification); no chunks started. V1 is the natural first pickup.
...
1. **Inline remake filters ×3** bypassing the `excludeRemakes()` invariant:
   - [recap-top-insight.tsx:80](../../../apps/web/src/lol/recap/recap-top-insight.tsx#L80) — `matches.filter((m) => m.win && !m.remake)`
   - [profile-lp-history.tsx:338](../../../apps/web/src/lol/profile/profile-lp-history.tsx#L338)
   - [routes/lol/$accountSlug/champions/$championKey.tsx:210](../../../apps/web/src/routes/lol/$accountSlug/champions/$championKey.tsx#L210)
