...
**Status:** Active — V1 in progress (picked up 2026-06-12 with V2, V5, V8 in the same session plan). V1.1 (remake filters) + V1.2 (`ChapterLabel` recipe) + V1.3 (`ChapterShell` frosted wrappers) shipped; V1.4, V2, V5, V8 next.
