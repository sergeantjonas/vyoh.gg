...
| 2 | `platforms.steam_deck_compat_category` chip | [quick-wins.md](../cross-cutting/quick-wins.md) | Planned |
| 3 | `platforms.windows / mac / linux / vr_support` pills | [quick-wins.md](../cross-cutting/quick-wins.md) | Planned |
